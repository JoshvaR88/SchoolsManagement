...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { course_id: @batch.course_id, end_date: @batch.end_date, name: @batch.name, start_date: @batch.start_date } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { course_id: @batch.course_id, end_date: @batch.end_date, name: @batch.name, start_date: @batch.start_date } }
